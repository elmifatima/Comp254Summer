...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  //METHOD CHANGED FROM CONTAINKEY TO CONTAINSKEY
  //========================================================
  public boolean containsKey(K key)
  {
	  ...
	  checkKey(key);            //check if key is valid NOT null 
	  int j = findIndex(key);  // return the index where key should be
	  return (j < size() && compare(key, table.get(j)) ==0); // size is with in range and confirm match
  }
  
  //ADDED METHOD TO DISPLAY DATA
  //===================================================================
  public void display() {
	  System.out.println("List of Data entries in the map");
...
// test method
	public static void main(String [] args) {
		...
		System.out.println("Does key 2 exist? " + map.containsKey(2)); // true
		System.out.println("Does key 5 exist? " + map.containsKey(5)); // false 
		System.out.println("Does key 6 exist? " + map.containsKey(6)); // Null value 
