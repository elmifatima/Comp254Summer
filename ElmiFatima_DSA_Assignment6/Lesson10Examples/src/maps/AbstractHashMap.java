...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  //=================================================
  protected float maximumloadFactor;  // Custom load factor
  ...
  // Exercise 1 implementation include laodFactor in Constructor
  //============================================================
  /** Creates a hash table with the given capacity and prime factor. */
  public AbstractHashMap(int cap, int p, float loadFactor) {
    prime = p;
    capacity = cap;
    this.maximumloadFactor = loadFactor;  // added to constructor
  ...
  // Update the to reflect loadFactor changes
  //===========================================================
  @Override
  public V put(K key, V value) {
    ...
    //=============New Capacity
    if (n > capacity * maximumloadFactor)
  ...
  private void resize(int newCap) {
	  ...
	  //====================== added to show output
	System.out.println("Resizing to Capacity: " + newCap);
