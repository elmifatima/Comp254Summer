...
public static void main(String[] args) {
	UnsortedTableMap<String, String> unsortedTableMap = new UnsortedTableMap<String, String>();
	
	unsortedTableMap.put("one", "COMP-254");
	unsortedTableMap.put("two", "COMP-304");
	unsortedTableMap.put("three", "COMP-229");
	
	System.out.println(unsortedTableMap.get("two"));
	System.out.println(unsortedTableMap.put("two", "COMP-311"));
	
	//USING A FOR EACH LOOP
	System.out.println("\nUsing a for each loop: ");
	
	for (Entry<String, String> entry: unsortedTableMap.entrySet())
	{
		System.out.println("(" + entry.getKey()+ ", "+entry.getValue()+ ")");
	}
	
	
	//USING ENTRYITERATOR METHODS
	Iterator<Entry<String, String>> entryIterator = unsortedTableMap.entrySet().iterator();
	System.out.println("\nUsing EntryIterator methods: ");
